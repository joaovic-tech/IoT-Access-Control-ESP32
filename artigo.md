...
![ESP32-CAM com câmera OV2640](./docs/images/placa_adaptada.jpg)
...
### Anexo A - Imagens do Protótipo

**Figura A1 - Sensor PIR**

![Sensor PIR](./docs/images/sensor-pir.jpg)

Fonte: O autor (2026).

---

**Figura A2 - Teste inicial do ESP32-CAM**

![Teste inicial do projeto](./docs/images/teste_01.jpg)

Fonte: O autor (2026).

---

**Figura A3 - Sensor PIR adaptado**

![Detalhe das conexões do sensor PIR](./docs/images/sensor_pir_adaptado.jpg)

Fonte: O autor (2026).

---

## ESPECIFICAÇÕES DE FORMATAÇÃO ABNT

Para conversão deste documento para .docx, aplicar as seguintes configurações:
...
- **Tamanhos:**
  ...
  - Resumo/Abstract: 12pt
  - Títulos de seção: 12pt, negrito
  - Citações longas (>3 linhas): 10pt, recuo de 4cm
  - Notas de rodapé: 10pt
  - Legendas de figuras: 10pt

### Espaçamento

- **Corpo do texto:** 1,5 linhas
- **Resumo:** 1,5 linhas, parágrafo único
- **Referências:** 1,0 linha (simples)
- **Citações longas:** 1,0 linha (simples)

### Alinhamento

- **Texto:** Justificado
- **Referências:** Alinhadas à esquerda (sem justificação)
- **Título do trabalho:** Centralizado (na primeira página)
- **Autoria:** Alinhada à direita

### Numeração

- **Páginas:** Numeração arábica (1, 2, 3...) no canto superior direito
- **A partir da:** Página 2 (a página 1 é a capa, sem numeração visível)
